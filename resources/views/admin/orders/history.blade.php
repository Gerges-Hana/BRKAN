                            ...
                            <div class="card">
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-linetriangle nav-justified" id="tab-bottom-arrow-drag">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="activeIcon22-tab1" data-toggle="tab" href="#activeIcon22" aria-controls="activeIcon22" aria-expanded="true"><i
                                                    class="la la-check"></i>عرض الطلبية </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="linkIcon22-tab1" data-toggle="tab" href="#linkIcon22" aria-controls="linkIcon22" aria-expanded="false"><i class="la la-link"></i>
                                                تحديثات الطلبيه</a>
                                        </li>
                                        ...
                                        <div class="tab-pane" id="linkIcon22" role="tabpanel" aria-labelledby="linkIcon22-tab1" aria-expanded="false">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                @foreach($order->purchaseOrderUpdates as $order)
                                                        ...
                                                        $date = '';
                                                        $time = '';
                                                        if ($created_at && strpos($created_at, ' ') !== false) {
                                                            $dateTimeParts = explode(' ', $created_at);
