...
@section('content-header')
    <div class="content-header-left col-md-6 col-12 mb-1">
        <h3 class="content-header-title">جميع الطلبيات</h3>
    </div>
    <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                <li class="breadcrumb-item active">جميع الطلبيات</li>
            </ol>
        </div>
    </div>
@endsection
        ...
        function purchaseOrdersDataTable() {
            $('#purchaseOrdersTable').DataTable({
                ...
                fnStateSave: function(oSettings, oData) {
                    localStorage.setItem('indexPurchaseOrdersDataTables', JSON.stringify(oData));
                },
                fnStateLoad: function(oSettings) {
                    return JSON.parse(localStorage.getItem('indexPurchaseOrdersDataTables'));
                },
