...
@section('content-header')
    <div class="content-header-left col-md-6 col-12 mb-1">
        <h3 class="content-header-title">طلبيات اليوم</h3>
    </div>
    <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">الرئيسية</a></li>
                <li class="breadcrumb-item active">طلبيات اليوم</li>
            </ol>
        </div>
    </div>
@endsection
        ...
        function purchaseOrdersDataTable() {
            $('#purchaseOrdersTable').DataTable({
                ...
                fnStateSave: function(oSettings, oData) {
                    localStorage.setItem('todayPurchaseOrdersDataTables', JSON.stringify(oData));
                },
                fnStateLoad: function(oSettings) {
                    return JSON.parse(localStorage.getItem('todayPurchaseOrdersDataTables'));
                },
                language: dataTablesArabicLocalization,
                ajax: {
                    url: "{{ route('orders.todayPurchaseOrdersData') }}",
                    method: 'POST',
                    dataType: "JSON",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
