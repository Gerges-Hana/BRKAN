                    ...
                    <div class="card-header card-header-transparent py-20">
                        ...
                        <ul class="nav nav-pills nav-pills-rounded chart-action float-right btn-group" role="group">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                    href="#scoreLineToWeek">الاسبوع</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                    href="#scoreLineToMonth">الشهر</a></li>
                        </ul>
                    </div>
    ...
    <script>
        ...
        (function(window, document, $) {
            ...
            (function() {
                ...
                var DayLabelList = ["اليوم", "الامس", "من 3 ايام", "من 4 ايام", "من 5 ايام", "من 6 ايام",
                    "من 7 ايام", "من 8 ايام"
                ];

                var DaySeries1List = {
                    name: "series-1",
                    data: ['{{ $day_1 }}', '{{ $day_2 }}', '{{ $day_3 }}',
                        '{{ $day_4 }}', '{{ $day_5 }}', '{{ $day_6 }}',
                        '{{ $day_7 }}', '{{ $day_8 }}'
                    ]
                };

                var WeekLabelList = ["الاسبوع الحالي ", "الاسبوع السابق", "  من ثالث اسبوع ", "من رابع اسبوع  ",
                    "من خامس اسبوع ", "من سادس اسبوع ", "من سابع اسبوع ", " من ثامن اسبوع "
                ];

                var WeekSeries1List = {
                    name: "series-1",
                    data: ['{{ $week_1 }}', '{{ $week_2 }}', '{{ $week_3 }}',
